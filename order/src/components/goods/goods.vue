            ...
            <ul>
              <li v-for="food in item.foods" @click="selectFood(food)" class="food-item border-1px">
                ...
                <div class="content">
                  ...
                  <div style="display: none">{{food.id}}</div>
...
export default {
  ...
  created() {
    ...
    var bedid = localStorage.getItem("bed-id"); // 床位id
    var bedname = localStorage.getItem("bed-name"); // 床位号
    console.log(wardid,wardname,bedid,bedname);
